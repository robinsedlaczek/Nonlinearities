...
namespace Nonlinearities.Analysis
{
    public class LoessInterpolator
    {
         ...
         */
        private int _robustnessIters;

        public LoessInterpolator()
        {
            this.bandwidth = DEFAULT_BANDWIDTH;
            this._robustnessIters = DEFAULT_ROBUSTNESS_ITERS;
        }
        ...
        public LoessInterpolator(double bandwidth, int robustnessIters)
        {
            ...
            this._robustnessIters = robustnessIters;
        }
        ...
        public double[] Smooth(double[] xval, double[] yval)
        {
            ...
            // Do an initial fit and '_robustnessIters' robustness iterations.
            // This is equivalent to doing '_robustnessIters+1' robustness iterations
            ...
            for (int iter = 0; iter <= _robustnessIters; ++iter)
            {
                ...
                for (int i = 0; i < n; ++i)
                {
                    ...
                    robustnessWeights[i] = (arg >= 1) ? 0 : System.Math.Pow(1 - arg * arg, 2);
                }
            }
